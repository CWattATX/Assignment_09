...
# CWatt, 2022-Dec-12, Modified file to handle tracks on CDs and handle lists of files
#---------------------------------------------#
...
class FileIO:
    ...
    def load_inventory(file_name: list) -> list:
        ...
        lst_Inventory = []
        # ToDone modify to accept list
        file_name_CD = file_name[0]
        file_name_trk = file_name[1]
        try:
           #ToDone load track data
